...
Now we do the initial build and push
...
Keep a note of the version number.

Then - SSH into the server and create a `.env` file as follows:

```bash
export TRIM=production
export CONTRACT_ADDRESS=<as above>
export VERSION=<as above>
```
