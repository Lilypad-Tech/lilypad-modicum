...
class ModicumContract(Contract):
	...
	def postJobOfferPartTwo(self, from_account, getReceipt, ijoid, ramLimit, localStorageLimit, uri, directory, jobHash, arch, extras):
