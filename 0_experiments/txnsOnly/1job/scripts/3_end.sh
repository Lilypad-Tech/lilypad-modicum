...
mv ./logs/modicum.log ~/projects/MODiCuM/logs/"$stamp"_node24.log

rsync --remove-source-files -v -e "ssh -p222 -i /home/riaps/.ssh/cluster_2018_9_10" riaps@172.21.20.27:~/modicum.log ./logs/
mv ./logs/modicum.log ~/projects/MODiCuM/logs/"$stamp"_node27.log

rsync --remove-source-files -v -e "ssh -p222 -i /home/riaps/.ssh/cluster_2018_9_10" riaps@172.21.20.30:~/modicum.log ./logs/
mv ./logs/modicum.log ~/projects/MODiCuM/logs/"$stamp"_node30.log


mv /home/riaps/modicum.log ~/projects/MODiCuM/logs/"$stamp"_node1.log
